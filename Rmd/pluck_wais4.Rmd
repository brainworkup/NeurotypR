...
if (params$test == "conners4_self") {
  saveRDS(file, "conners4_self.rds")
} else if (params$test == "conners4_parent") {
  saveRDS(file, "conners4_parent.rds")
} else if (params$test == "conners4_teacher") {
  saveRDS(file, "conners4_teacher.rds")
}
```
...
f <- file.path("/Users/joey/reports/Edward/pdf/Edward_adhd_ld_battery-2a4e56ea-524d-496f-a277-5d4f356a60ca.pdf")
