...
#' @description A character vector of scale names related to academic skills including reading, writing, mathematics, and related cognitive abilities from various academic achievement tests.
#' @keywords data
scales_academics <- c(
...
#' @name scales_verbal
#' @docType data
#' @title Verbal and Language Scales
#' @description A character vector of scale names related to verbal abilities, language comprehension, expression, and communication skills from various neuropsychological and language tests.
#' @keywords data
scales_verbal <- c(
  "Academic Language Readiness Index",
