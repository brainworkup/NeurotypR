...
generate_qmd_content <- function(
  ...
  table_chunk <- paste0(
    ...
    "multiline <- TRUE\n\n",
    "# footnotes\n",
    # For percentile symbols in footnotes, replace ‰ with \u2030
    ...
    "grp_executive <- list(\n",
    "  scaled_score = intersect( # nolint\n",
    "    all_grp_executive[[\"scaled_score\"]],\n",
    "    existing_test_names\n",
    "  ),\n",
    "  standard_score = intersect( # nolint\n",
    "    all_grp_executive[[\"standard_score\"]],\n",
    "    existing_test_names\n",
    "  ),\n",
    "  t_score = intersect(all_grp_executive[[\"t_score\"]], existing_test_names) # nolint\n",
    ")\n\n",
    "# Only create table if we have data # nolint\n",
