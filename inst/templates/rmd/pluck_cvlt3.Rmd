...
params:
  ...
  table1:
    ...
    value: [Trial 1 Correct, Trial 2 Correct, Trial 3 Correct, Trial 4 Correct, Trial 5 Correct, List B Correct]
    input: select
    multiple: yes
    choices:
      - Trial 1 Correct
  ...
  table3:
    ...
    value: [Short Delay Free Recall, Short Delay Cued Recall, Long Delay Free Recall, Long Delay Cued Recall]
    input: select
    multiple: yes
    choices:
...
```{r save}
writeLines(file, here::here("data", "cvlt3_pdf"))
```
...
if (params$test == "cvlt3") {
  cvlt3 <-
    tidytable::bind_rows(table1, table2, table3, table4, table5, table6)
}
...
if (params$test == "cvlt3") {
  readr::write_excel_csv(
    cvlt3,
    here::here("data", "csv", "cvlt3.csv")
  )
} else if (params$test == "cvlt3_brief") {
  readr::write_excel_csv(
    cvlt3_brief,
    here::here("data", "csv", "cvlt3_brief.csv")
  )
}
```
