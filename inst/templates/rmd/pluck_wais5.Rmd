...
```{r eval = FALSE}
# f <- file.path("/Users/joey/reports/Max/pdf/Max_adhd_ld_battery-2a4e56ea-524d-496f-a277-5d4f356a60ca.pdf")
...
# qs2::qd_save(extracted_areas, file = "extracted_areas.rds")
# areas <- qs::qread("~/Max/src/rmd/areas_wisc5.rds")
```
...
```{r}
# Save the entire list to an R data file
qs2::qd_save(extracted_tables, file = "extracted_tables_wais5.rds")
extracted_tables <- qs::qread("extracted_tables_wais5.rds")
# Load the entire list from an R data file
```

# WAIS-V Subtest Scores (Tables 1-5)
