...
filename <- "table_emotion_child_self.png"
...
bwu::cat_neuropsych_results(
  ...
  file = "_02-09_emotion_child_text_parent.qmd"
)
```
...
bwu::cat_neuropsych_results(
  ...
  file = "_02-09_emotion_child_text_teacher.qmd"
)
```
...
# define the groupings for the table
grp_emotion <- list(
  t_score = c("BASC-3 SRP", "BASC-3 TRS", "BASC-3 PRS", "PAI-A", "MMPI-3")
)
