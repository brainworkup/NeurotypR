...
# df <- vroom::vroom("data/csv/nab.csv")

# Merge the data with the lookup table
df_merged <- df |>
  dplyr::left_join(lookup_table, by = c("test" = "test", "test_name" = "test_name", "scale" = "scale")) |>
  dplyr::arrange(test, test_name, scale) |> # Sort by test and scale
