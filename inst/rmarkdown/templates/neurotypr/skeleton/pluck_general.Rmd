...
params:
  ...
  table2:
    ...
    choices:
      ...
      - Information
      - Comprehension
  extract_columns: [1, 2, 3, 4, 5, 6, 7, 8]
...
Locate or extract areas with `tabulapdf`
...
```{r eval = TRUE}
# pdf <- file.path("/Users/joey/reports/Biggie/pdf/Edward_adhd_ld_battery-2a4e56ea-524d-496f-a277-5d4f356a60ca.pdf")
...
save(extracted_areas, file = "extracted_areas.RData")
```
...
f <- file.path("/Users/joey/reports/Biggie/pdf/Edward_adhd_ld_battery-2a4e56ea-524d-496f-a277-5d4f356a60ca.pdf")
...
extracted_tables <- bwu::gpluck_extract_table(
  file = file,
  pages = pages,
  area = area,
  guess = "FALSE",
