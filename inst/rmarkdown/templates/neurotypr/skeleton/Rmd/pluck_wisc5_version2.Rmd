...
params:
  ...
  file:
    ...
    value: file
    input: file
  pages: [30, 30, 30, 30, 30, 31, 34, 37, 38]
  table1:
  ...
  table9:
    label: "PROCESS ANALYSIS (CONTINUED)"
    value: ["Longest Digit Span Forward"]
    input: select
    multiple: yes
    choices:
...
**TODO: add 3 other tables 7/1/24**
