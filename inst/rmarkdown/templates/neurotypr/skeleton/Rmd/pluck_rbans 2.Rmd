...
file_path <- "'/Users/joey/Library/CloudStorage/GoogleDrive-j.trampush@gmail.com/My Drive/rbans/harry_scores.csv'"
drive_upload(media = file_path, name = "harry_scores.csv")
```
...
```{r}
library(tidyverse)
input_file_path <- "data/harry_scores.csv"
...
```{r}
readr::write_csv(rbans, here::here("data", "csv", "rbans.csv"), col_names = TRUE, na = "")
```
