...
```{r}
#| label: export-daily-living
#| include: false

# Read the CSV file into a data frame
daily_living <- readr::read_csv("neurocog.csv")
...
```{r}
#| include: false
source("NeurotypR::tbl_gt2.R")
```

```{r}
#| label: qtbl-daily-living
#| dev: tikz
#| fig-process: pdf2png
#| include: false
#| eval: true
...
#let file_fig = "fig_daily_living.svg"
#domain(
  title: [#title Scores],
  file_qtbl,
  file_fig
