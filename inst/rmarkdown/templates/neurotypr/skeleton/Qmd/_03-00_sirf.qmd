...
g <- readr::read_csv("data/csv/g.csv")
...
#let domain(file_fig) = {
  ...
  figure(
    ...
    caption: figure.caption(
      position: bottom,
      [
        Plots depicting the patient’s strengths and weaknesses across neurocognitive function subdomains. _Note:_ z-scores are standardized with a mean of 0 and a standard deviation of 1.
        ],
    ),
    kind: "image",
    supplement: [Figure],
